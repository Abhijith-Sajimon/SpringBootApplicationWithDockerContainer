...
public class Constants {
    ...
    public static final String ERROR_BAD_REQUEST_SERVLET_REQUEST_PART_FILE_MISSING = "Servlet request part 'file' missing";
    public static final String ERROR_BAD_REQUEST_SERVLET_REQUEST_PART_USERNAME_MISSING = "Servlet request part 'username' missing";
